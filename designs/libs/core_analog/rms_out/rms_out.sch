...
N 120 -170 320 -170 {lab=vrms}
N 120 -80 120 -20 {lab=vss}
N 120 -160 120 -140 {lab=vrms}
N 70 -150 120 -150 {lab=vrms}
...
C {symbols/pfet_03v3.sym} 100 -310 0 0 {name=M1
L=0.28u
W=0.22u
nf=1
m=1
...
C {opin.sym} 320 -170 0 0 {name=p4 lab=vrms}
C {ammeter.sym} 120 -220 0 0 {name=ieven_mirror savecurrent=true spice_ignore=0}
C {symbols/nfet_03v3.sym} 100 -110 0 0 {name=M2
L=0.28u
W=0.22u
nf=1
m=1
